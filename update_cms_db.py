...
# Eğer theme_settings sütunu yoksa ekle
if 'theme_settings' not in column_names:
    cursor.execute("ALTER TABLE site_settings ADD COLUMN theme_settings JSON")
    print("theme_settings sütunu eklendi")
else:
    print("theme_settings sütunu zaten var")
